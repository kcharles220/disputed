...
export async function GET(req: NextRequest) {
  try {
    ...
    const user = await db.collection('users').findOne(
      ...
      { 
        projection: { 
          ...
          currentWinStreak: 1,
          // Role-specific stats
          attackerRoundsPlayed: 1,
          attackerRoundsWon: 1,
          attackerPointsWon: 1,
          attackerAverageScore: 1,
    ...
    return NextResponse.json({
      ...
      // Role-specific stats
      attackerRoundsPlayed: user.attackerRoundsPlayed || 0,
      attackerRoundsWon: user.attackerRoundsWon || 0,
      attackerPointsWon: user.attackerPointsWon || 0,
      attackerAverageScore: user.attackerAverageScore || 0,
